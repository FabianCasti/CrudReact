        ...
        <div className='form'>
            <form onSubmit={submit}>
                ...
                <div>
                    ...
                    <input autocomplete='off' type="text" placeholder='Name' id='name' value={firstName} onChange={(e) => { setFirstName(e.target.value) }} />
                    <label htmlFor="lastName"></label>
                    <input autocomplete='off' type="text" placeholder='Last name' id='lastName' value={lastName} onChange={e => setLastName(e.target.value)} />                
                </div>
    
                <div>
                    <label htmlFor="email"><FontAwesomeIcon icon={faEnvelope} /></label>
                    <input autocomplete='off' type="email" placeholder='Email' id='email' value={email} onChange={e => setEmail(e.target.value)} />
                </div>
                <div>
                    <label htmlFor="password"><FontAwesomeIcon icon={faKey} /></label>
                    <input autocomplete='off' type="password" placeholder='Password' id='password' value={password} onChange={e => setPassword(e.target.value)} />
                </div>
                <div>
